    ...
    <div className="space-y-4 animate-in fade-in duration-500">
      ...
      {vault.length > 0 && (
        <button 
          ...
          className="w-full bg-white/5 border border-white/5 rounded-2xl p-4 flex items-center gap-4 group active:bg-white/10 transition-all mb-4"
        >
          <div className="w-10 h-10 rounded-full bg-purple-500/20 flex items-center justify-center text-purple-400">
            <Layers size={18} />
          </div>
          <div className="text-left">
            <div className="font-tech text-xs tracking-widest uppercase">Generate Master QR</div>
            <div className="text-[9px] font-mono text-white/20 uppercase tracking-widest">Sync all {vault.length} records at once</div>
          </div>
        </button>
      )}
